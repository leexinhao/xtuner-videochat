...
from xtuner.v1.model import VideoChat3Dense4BT1Config
...
model_path = "/mnt/petrelfs/zengxiangyu/Research_lixinhao/xtuner-videochat/work_dir/VideoChat3_4B_train_stage1-2_t1/20251216125231/hf-latest"
meta_data_path = '/mnt/petrelfs/zengxiangyu/Research_lixinhao/xtuner-videochat/training_data_annotations/data_stage2_llava_video_academic_shortcotqa20251216_bee_image_temp.json'
work_dir = "work_dir/VideoChat3_4B_train_stage2_llava_video_academic_shortcotqa20251216_bee_image_temp_t1"
cache_dir = "dataset_cache/cache_videochat3_4B_stage2_llava_video_academic_shortcotqa20251216_bee_image_temp_t1"
...
for name, _data in ds_collections.items():
    _data_cfg = {"dataset": DatasetConfig(name=name,
                 ...
                 "tokenize_fn": VideoChat3TokenizeFnConfig(
                    ...
                    image_max_pixels=_data.get('image_max_pixels', int(sample_max_length * 0.6 * 28 * 28)),
                    frame_min_pixels=_data.get('frame_min_pixels', 28*28),
                    frame_max_pixels=_data.get('frame_max_pixels', 448*448),
                    video_max_total_pixels=_data.get('video_max_total_pixels', int(sample_max_length * 0.6 * 1 * 28 * 28)),
                    ...
                    video_sample_fps=_data.get('video_sample_fps', 0.25), 
