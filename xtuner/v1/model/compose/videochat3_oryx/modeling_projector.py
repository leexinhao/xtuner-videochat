...
from .videochat3_oryx_config import VideoChat3OryxProjectorConfig
...
class VideoChat3OryxMultiModalProjector(BaseModel):
    config: VideoChat3OryxProjectorConfig

    def __init__(self, config: VideoChat3OryxProjectorConfig):
        super().__init__()
        self.hidden_size = (
