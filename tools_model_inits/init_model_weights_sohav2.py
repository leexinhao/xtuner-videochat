...
def load_weights_from_safetensors(model_path: str):
    ...
    # 检查单个safetensors文件
    single_file = os.path.join(model_path, "model-0001-others-save_rank0.safetensors")
...
def main():
    ...
    # 设置路径
    vit_path = "/mnt/petrelfs/zengxiangyu/Research_lixinhao/xtuner-videochat/work_dir/stage1-2/VideoChat3_4B_train_stage1-2_soha_v2_lr8e-5_16k/20260123011234/hf-3444"
    qwen3_path = "/mnt/petrelfs/zengxiangyu/Research_lixinhao/models/Qwen3-4B-Instruct-2507"
    current_dir = "/mnt/petrelfs/zengxiangyu/Research_lixinhao/xtuner-videochat/VideoChat3-4B_sohav2"
