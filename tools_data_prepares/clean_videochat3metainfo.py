...
wrong_cnt = 0
json_root = "/mnt/petrelfs/zengxiangyu/Research_lixinhao/videochat3_data_annotations/video/tarster_video"
save_root = "/mnt/petrelfs/zengxiangyu/Research_lixinhao/videochat3_data_annotations/video/tarster_video_clean"
for json_name in os.listdir(json_root):

    jsonl_path = os.path.join(json_root, json_name)
    save_path = os.path.join(save_root, json_name.replace('.jsonl', '_clean.jsonl'))
