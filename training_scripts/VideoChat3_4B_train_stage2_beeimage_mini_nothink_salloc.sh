...
TASK_NAME="VideoChat3_4B_train_stage2_beeimage_mini_nothink"
...
$bin torchrun --nnodes=$nnodes \
        ...
        xtuner/v1/train/cli/sft.py --config training_configs/videochat3/VideoChat3_4B_train_stage2_beeimage_mini_nothink.py 2>&1 | tee -a "${OUTPUT_DIR}/training_log_${TASK_NAME}_${current_time}.txt"
