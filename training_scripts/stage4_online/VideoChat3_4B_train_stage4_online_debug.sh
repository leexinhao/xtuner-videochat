...
TASK_NAME="VideoChat3_4B_train_stage4_online_debug"
...
torchrun --nnodes=$nnodes \
        ...
        xtuner/v1/train/cli/sft.py --config training_configs/stage4_online/${TASK_NAME}.py 2>&1 | tee -a "${OUTPUT_DIR}/training_log_${TASK_NAME}_${current_time}.txt"
