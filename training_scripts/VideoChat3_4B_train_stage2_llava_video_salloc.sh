...
TASK_NAME="VideoChat3_4B_train_stage2_llava_video"
...
$bin torchrun --nnodes=$nnodes \
        ...
        xtuner/v1/train/cli/sft.py --config training_configs/videochat3/VideoChat3_4B_train_stage2_llava_video.py 2>&1 | tee -a "${OUTPUT_DIR}/training_log_${TASK_NAME}_${current_time}.txt"
